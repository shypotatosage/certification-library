...
@section('content')
    <div class="container mx-auto p-4 md:p-6 pt-6">
        <div class="mb-6">
            <x-search-filter-form :categories=$categories action="{{ url('/') }}" />
        </div>
            ...
            @empty
                <div class="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-4 text-center">
                    <div class="p-6 border-2 border-gray-300 rounded-lg bg-gray-100 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mt-2">Try changing your search criteria or select a different category.</p>
                    </div>
                </div>
            @endforelse
        </div>
